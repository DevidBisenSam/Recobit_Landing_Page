...
import { ArrowRight, ChevronDown, Sparkles, Shield, Activity, Zap } from 'lucide-react';
          ...
          <div ref={cardRef} className={styles.floatingHeroCard}>
            <div className={styles.cardHeader}>
              <div className={styles.cardHeaderLeft}>
                ...
                <span className={styles.cardHeaderTitle}>Inbound Bank Pipeline</span>
              </div>
              <span className={styles.cardHeaderBadge}>AUTO-INGESTION ACTIVE</span>
            </div>
