...
import { ArrowRight, CheckCircle2, Sparkles, Shield, Building, Mail, User } from 'lucide-react';
import { storyContent } from '@/config/storyContent';
import styles from './Scene15FinalCta.module.css';

gsap.registerPlugin(ScrollTrigger);

export const Scene15FinalCta: React.FC = () => {
